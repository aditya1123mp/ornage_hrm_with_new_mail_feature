...
WebUI.setText(findTestObject('Object Repository/LOGIN_TEST_CASE_FOR_ORANGE_HRM/username_text_box_login_page'), 'Admin')
...
WebUI.setText(findTestObject('Object Repository/LOGIN_TEST_CASE_FOR_ORANGE_HRM/password_text_box_for_login_page'), 'admin123')
